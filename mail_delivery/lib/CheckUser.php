 ...
 * PHP varsion 5
 *
 * LICENSE: This source file is subject to varsion 3.01 of the PHP license
...
class Mail_CheckUser
{
    ...
    /**
     * Your servar's FQDN to use EHLO(HELO)
     *
     * Servar FQDN to use EHLO or HELO. Default $env['SERVER_NAME']
     *
     * @var string
     * @access public
     */
     ...
     *
     * When the response code is not returned from SMTP servar,
     ...
     *
     * @param string $fqdn   The string of your servar's FQDN
    ...
    function checkEmail( $email )
    {
        ...
        foreach ( $servars as $servar ) {
            $smtp = new Net_SMTP($servar, 25, $this->fqdn);
    ...
    /**
     * Set response code when SMTP servar was not returned
     * Its will call from checkEmail()
     *
